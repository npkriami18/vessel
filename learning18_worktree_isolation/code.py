#!/usr/bin/env python3
"""
learning18: Worktree Isolation — git worktree + task-directory binding + event log.

Run:  python learning18_worktree_isolation/code.py
...
# ── Task System (from learning12 + learning18 worktree field) ──
...
class Task:
    ...
    owner: str | None
    blockedBy: list[str]
    worktree: str | None = None      # learning18: bound worktree name
...
# ── Worktree System (learning18 new) ──
...
# ── Autonomous Agent (from learning17, + worktree cwd) ──
...
# ── Teammate Thread (from learning15 + learning16 + learning17 + learning18) ──
...
# ── Lead Worktree Tools (learning18 new) ──
...
if __name__ == "__main__":
    print("learning18: worktree isolation")
    print("Enter a question, press Enter to send. Type q to quit.\n")
    history = []
    context = {"memories": ""}
    while True:
        try:
            query = input("\033[36mlearning18 >> \033[0m")
