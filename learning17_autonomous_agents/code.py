#!/usr/bin/env python3
"""
learning17: Autonomous Agents — idle poll + auto-claim + WORK/IDLE lifecycle.

Run:  python learning17_autonomous_agents/code.py
Need: pip install openai python-dotenv + .env with AZURE_API_KEY, AZURE_ENDPOINT,
...
# ── Prompt Assembly (from learning10) ──
...
# ── Protocol State (from learning16) ──
...
# ── Autonomous Agent (learning17 new) ──
...
# ── Teammate Thread (from learning15 + learning16 + learning17) ──
...
def spawn_teammate_thread(name: str, role: str, prompt: str) -> str:
    ...
    def run():
        ...
        sub_tools = [
            ...
            {"type": "function", "function": {
                ...
                "parameters": {"type": "object",
                               ...
                               "required": ["plan"]}}},
            # learning17 new: teammates can list, claim, and complete tasks
            {"type": "function", "function": {
                "name": "list_tasks",
        ...
        while True:
            # Identity re-injection (learning17)
            if len(messages) <= 3:
...
# ── Lead Protocol Tools (from learning16) ──
...
if __name__ == "__main__":
    print("learning17: autonomous agents")
    print("Enter a question, press Enter to send. Type q to quit.\n")
    history = []
    context = {"memories": ""}
    while True:
        try:
            query = input("\033[36mlearning17 >> \033[0m")
