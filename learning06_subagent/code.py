#!/usr/bin/env python3
"""
learning06: Subagent — spawn subagents with fresh context for focused subtasks.
...
Changes from learning05:
  ...
  + Subagent loop with 30-turn safety limit
  + extract_text() helper for final summary
  + Parent keeps only the conclusion, not the child history
  Subagent cannot spawn sub-subagents (no task tool in sub_tools).

Run: python learning06_subagent/code.py
...
# ═══════════════════════════════════════════════════════════
#  FROM learning02-learning05 (unchanged): Tool Implementations
# ═══════════════════════════════════════════════════════════
...
# ═══════════════════════════════════════════════════════════
#  FROM learning04-learning05 (unchanged): Hook System
# ═══════════════════════════════════════════════════════════
...
# ═══════════════════════════════════════════════════════════
#  NEW in learning06: Subagent helpers
# ═══════════════════════════════════════════════════════════
...
# ═══════════════════════════════════════════════════════════
#  agent_loop — Azure style + todo reminder + task dispatch
# ═══════════════════════════════════════════════════════════
...
if __name__ == "__main__":
    print("learning06: Subagent — delegate focused subtasks with fresh context")
    print("Enter a prompt, or q to quit.\n")

    history = []
    while True:
        try:
            query = input("\033[36mlearning06 >> \033[0m")
